...
S3Pusher = (function() {
  function S3Pusher(replace_dist_haed) {
    var argv;
    argv = cli.argv;
    ...
    if (argv.version) {
      ...
      return this.push(argv.directory, new RegExp("^"+replace_dist_haed+"/","g"));
    } else {
      console.log(cli.help());
    }
  }

  S3Pusher.prototype.push = function(dir, re) {
    var files;
    return files = this.pusher.push(dir, re);
  };
