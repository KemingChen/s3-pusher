...
Pusher = (function() {
    ...
    Pusher.prototype.push = function(dir, re) {
        ...
        return this.initialize(function() {
            ...
            _this.client = s3.createClient({
                s3Options: {
                    accessKeyId: _this.ACCESS_KEY,
                    secretAccessKey: _this.SECRET_KEY,
                    region: "Tokyo",
                },
            });
            _ref = _this.files;
    ...
    Pusher.prototype.upload = function(file, re, type) {
        ...
        uploader = this.client.uploadFile({
            localFile: file,
            s3Params: {
                Bucket: _this.BUCKET,
                Key: file.replace(re, ''),
        ...
        uploader.on("progress", function(amountDone, amountTotal) {
            return console.log(("Progress: " + uploader.progressMd5Amount + " of " + uploader.progressTotal).yellow);
        });
